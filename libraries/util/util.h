...
#define SERVER_STATE_SENSOR_CONNECTED 1
#define SERVER_STATE_SENSOR_READY 2
#define SERVER_STATE_REMOTE_CONNECTED 4
#define SERVER_STATE_REMOTE_READY 8
...
#define SENSOR_STATE_CAN_CONNECTED 1
#define SENSOR_STATE_TAG_CONNECTED 2
#define SENSOR_STATE_SERVER_CONNECTED 4
